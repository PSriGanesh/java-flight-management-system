...
public class AddInternationalFlight extends JFrame {
	...
	public AddInternationalFlight() {
		...
		departTime.setBounds(131, 90, 86, 20);
		contentPane.add(departTime);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (flightID.getText().equals("") || flightTime.getText().equals("") || departTime.getText().equals("") || departCity.getText().equals("") || 
				...
				internationalFlight obj=new internationalFlight(flightID.getText(),flightTime.getText(),departTime.getText(),departCity.getText(),landCity.getText()
						,economySeats.getText(),businessSeats.getText(),distance.getText());
				sqlconnect connection = new sqlconnect();
				Connection con = connection.connect();
				String query = "INSERT into intflights values('"+flightID.getText()+"','"+flightTime.getText()+"','"+departTime.getText()+"','"+departCity.getText()+"','"+landCity.getText()+"',"+economySeats.getText()+","+businessSeats.getText()+","+distance.getText()+")";
				Statement st=null;
				try {

...
public class EditLocalFlight extends JFrame {
	...
	public static void main(String[] args) {
		EditLocalFlight frame = new EditLocalFlight("000","00","00","00","00","0","0","0");
	 ...
	 * Create the frame.
	 */
	public EditLocalFlight(String fid,String time,String date,String depcity,String lancity,String ecseats,String bcseats,String dur) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					Statement st=null;
					String query = "update localflights set departtime='"+flightTime.getText()+"',fdate='"+flightDate.getText()+"',startloc='"+departCity.getText()+"',endloc='"+landCity.getText()+"',ecseats="+economySeats.getText()+",bcseats="+businessSeats.getText()+",duration="+distance.getText()+" Where flightid='"+flightID.getText()+"'";
					try {

	...
	public AddLocalFlight() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Flight obj=new Flight(flightID.getText(),flightTime.getText(),departTime.getText(),departCity.getText(),landCity.getText()
						,economySeats.getText(),businessSeats.getText(),distance.getText());
				sqlconnect connection = new sqlconnect();
				Connection con = connection.connect();
				String query = "INSERT into localflights values('"+flightID.getText()+"','"+flightTime.getText()+"','"+departTime.getText()+"','"+departCity.getText()+"','"+landCity.getText()+"',"+economySeats.getText()+","+businessSeats.getText()+","+distance.getText()+")";
				Statement st=null;
				try {

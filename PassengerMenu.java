...
public class PassengerMenu extends JFrame {
	...
	public static void main(String[] args) {
		PassengerMenu frame = new PassengerMenu("test");
	...
	public PassengerMenu(String user) {
		...
		String query  = "SELECT fname from users WHERE username='"+user+"'";
		...
		try {
			...
			if(rs.next()!=false) {
				lblNewLabel.setText("Welcome, "+rs.getString(1)+"!");
			}
		}catch(Exception i) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookLocalFlight obj=new BookLocalFlight(user);
				obj.setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookInternationalFlight obj=new BookInternationalFlight(user);
				obj.setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookingDetails obj = new BookingDetails(user);
				obj.setVisible(true);
				dispose();
			}
		});
